-- SENTINEL: paste this entire file into Supabase SQL Editor and run ONCE.
-- Creates schema and labeled presentation data. No credentials belong in this SQL.
-- If using this file, do not also run the separate migration and seed.
BEGIN;
...
COMMIT;
-- Next: create/sign in an Auth user, then edit and run authorize-operator.sql.
